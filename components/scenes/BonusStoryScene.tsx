...
const STORY: Line[] = [
  ...
  { speaker:"mirei",   text:"Karena kalian lahir kembali bersamaku di alam ini." },
  ...
  { speaker:"mirei",   text:"...", delay:800 },
  { speaker:"mirei",   text:"Kejunya meleleh sempurna." },
  ...
  { speaker:"mirei",   text:"Tapi lain kali bawa dua bungkus." },
  { speaker:"player",  text:"DUA BUNGKUS?!" },
